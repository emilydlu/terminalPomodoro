...
var _buildOptions = __webpack_require__(5);

var _buildOptions2 = _interopRequireDefault(_buildOptions);

var _validateStartTime = __webpack_require__(4);

var _validateStartTime2 = _interopRequireDefault(_validateStartTime);

var _formatTime2 = __webpack_require__(2);

var _formatTime3 = _interopRequireDefault(_formatTime2);

var _dateToSeconds = __webpack_require__(8);

var _dateToSeconds2 = _interopRequireDefault(_dateToSeconds);
...
function countdown() {
  ...
  this.emit('ticker', (0, _objectAssign2.default)(this.formatTime(), {
...
Timr.prototype = (0, _objectAssign2.default)(Object.create(_EventEmitter2.default.prototype), {
  ...
  formatTime: function formatTime() {
    var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'currentTime';
  ...
  changeOptions: function changeOptions(options) {
    var newOptions = this.startTime > 0 ? options : (0, _objectAssign2.default)({}, options, { countdown: false });

    this.options = (0, _buildOptions2.default)(newOptions, this.options);
  ...
  setStartTime: function setStartTime(startTime) {
    ...
    if (startTime) {
      var parsedDate = (0, _dateToSeconds2.default)(startTime);
    ...
    this.startTime = this.currentTime = (0, _validateStartTime2.default)(newStartTime);
...
var _buildOptions2 = __webpack_require__(5);
...
function formatTime(seconds, options) {
  var _buildOptions = (0, _buildOptions3.default)(options),
      formatOutput = _buildOptions.formatOutput,
      padRaw = _buildOptions.padRaw;
...
var _timeToSeconds = __webpack_require__(3);
...
function buildOptions(newOptions, oldOptions) {
  if (newOptions) {
    var formatOutput = newOptions.formatOutput,
        padRaw = newOptions.padRaw,
        countdown = newOptions.countdown;
  ...
  return (0, _objectAssign2.default)(oldOptions || defaults, newOptions);
}
...
var _Timr = __webpack_require__(1);
...
{
  validateStartTime: _validateStartTime2.default,
